...
│ --scan-id    -i      TEXT     Previous Scan ID (Will read from config, if not passed │
│                               as an option)                                          │
│ --api-check  -a               Print Shodan API Usage Limits                          │
│ --verbose    -v      INTEGER  Verbose mode. Repeat for increased verbosity           │
│                               [default: 0]                                           │
│ --version    -V                                                                      │
